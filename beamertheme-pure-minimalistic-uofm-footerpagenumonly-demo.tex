...
\usepackage{tikz}
\usetheme[lightmode, footerpagenumonly, showmaxslides]{pureminimalistic}
...
[width=.3\linewidth]{logos/UofM_preferred_rgb_CERI}}
\renewcommand{\logoheader}{\vspace{0.75em}}
% \renewcommand{\logoheader}{\includegraphics%
% [width=.75\linewidth]{logos/UofM_preferred_rgb_CERI}}
\renewcommand{\logofooter}{\includegraphics%
[width=1.0\linewidth]{logos/UofM_horiz_rgb_CERI}}

% if loaded after begin{document} a warning will appear: "pdfauthor already used"
\title[]{This is the normal length of a research paper:
always longer than you would expect}
\author{Christopher H. Scholz$^{1}$ and Eunseo Choi$^{2}$}
\institute{\newline\newline$^{1}$Lamont-Doherath Earth Observatory of the Columbia University $^{2}$Center for Earthquake Research and Institution, the University of Memphis, Memphis} 
\date{\today}
